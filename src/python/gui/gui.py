...
class AppWindow(QMainWindow):
    ...
    def __setStyle(self, widget):
        widget.setStyleSheet("QPushButton {color: rgb(148,148,148); font: bold 12px}")
